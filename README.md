...
|---------|-------------|-----------|--------|
| [CIFAR-10 Image Classification](./cifar10-classification) | Image classification on the CIFAR-10 dataset using Convolutional Neural Networks | PyTorch | Completed |
